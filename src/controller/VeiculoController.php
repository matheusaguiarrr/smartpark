<?php
    ...
    if(!is_null($veiculos) && !is_null($motoristas)){
        ...
        loadTemplateView('veiculo', ['estacionamento' => $estacionamento, 'veiculos' => $veiculos, 'motoristas' => $motoristas, 'vagas' => $vagas]);
    }
    loadTemplateView('veiculo', ['estacionamento' => $estacionamento, 'motoristas' => $motoristas, 'vagas' => $vagas]);