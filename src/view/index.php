                    ...
                    <form action="">
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" id="motorista" name="motorista" placeholder="Digite o nome do motorista">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="placa">Veículo</label>
                                <input type="text" id="veiculo" name="veiculo" placeholder="Digite o modelo do veículo">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="vaga">Vaga</label>
                                <input type="text" id="vaga" name="vaga" placeholder="Digite o número da vaga">
                            </div>
                        </div>
                    </form>
                </div>
